...
exports.setupMiniPlayerHandlers = setupMiniPlayerHandlers;
var electron_1 = require("electron");
var window_manager_1 = require("../lib/window-manager");
/**
 * ミニプレイヤー関連のIPCハンドラーをセットアップ
 */
function setupMiniPlayerHandlers() {
    var _this = this;
    // ミニプレイヤーを開く
    electron_1.ipcMain.handle("mini-player:open", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("ミニプレイヤーの作成に失敗:", error_1);
    ...
    electron_1.ipcMain.handle("mini-player:close", function (event) {
        try {
            ...
            // それ以外の場合は通常の閉じ方を試す
            (0, window_manager_1.closeMiniPlayer)();
            return { success: true };
        }
        catch (error) {
    ...
    electron_1.ipcMain.handle("mini-player:update-state", function (_event, state) {
        try {
